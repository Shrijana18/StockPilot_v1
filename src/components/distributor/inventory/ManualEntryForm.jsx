...
import PricingModeFields from "../../inventory/PricingModeFields";
import { PRICING_MODES, buildPricingSave } from "../../../utils/pricing";
import ProductBarcode from "../../inventory/ProductBarcode";
import MagicScanDisplay from "../../inventory/MagicScanDisplay";
              ...
              onAddSelected={async (selectedRows) => {
                ...
                try {
                  ...
                  for (const r of selectedRows) {
                    ...
                    const editedQty = editedRows[selectedRows.indexOf(r)]?.quantity;
                    const editedCost = editedRows[selectedRows.indexOf(r)]?.costPrice;
                    ...
                    const newDoc = {
                      ...
                      brand: r.brand || "",
                      category: r.category || "",
                      quantity: Number(editedQty || 0),
                      costPrice: Number(editedCost || 0),
                      sellingPrice: mrpNum,
                      pricingMode: PRICING_MODES.LEGACY,
                      mrp: mrpNum,
                      unit: r.unit || "",
