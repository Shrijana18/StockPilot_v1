import{F as ne,H as oe,_ as L,I as ie,J as se,K as m,L as ae,M as ce,N as U,P as le,Q as ue,R as D,S as N,U as de}from"./firebase-DWi1MSv1.js";/**
 * @license
 ...
 * @license
 * SPDX-License-Identifier: Apache-2.0
 */let he="google#safe";function ge(){if(typeof window<"u")return window.trustedTypes}function K(){var e;return(e=ge())!==null&&e!==void 0?e:null}let w;function pe(){var e,t;if(w===void 0)try{w=(t=(e=K())===null||e===void 0?void 0:e.createPolicy(he,{createHTML:r=>r,createScript:r=>r,createScriptURL:r=>r}))!==null&&t!==void 0?t:null}catch{w=null}return w}/**
 * @license
 * SPDX-License-Identifier: Apache-2.0
 */class z{constructor(t,r){this.privateDoNotAccessOrElseWrappedResourceUrl=t}toString(){return this.privateDoNotAccessOrElseWrappedResourceUrl.toString()}}function x(e){var t;const r=e,n=(t=pe())===null||t===void 0?void 0:t.createScriptURL(r);return n??new z(r,fe)}function ke(e){var t;if(!((t=K())===null||t===void 0)&&t.isScriptURL(e))return e;if(e instanceof z)return e.privateDoNotAccessOrElseWrappedResourceUrl;{let r="";throw new Error(r)}}/**
 * @license
 * SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const q="https://content-firebaseappcheck.googleapis.com/v1",_e="exchangeRecaptchaV3Token",ye="exchangeDebugToken",M={RETRIAL_MIN_WAIT:30*1e3,RETRIAL_MAX_WAIT:960*1e3},Re=1440*60*1e3;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pe{constructor(t,r,n,o,i){if(this.operation=t,this.retryPolicy=r,this.getWaitDuration=n,this.lowerBound=o,this.upperBound=i,this.pending=null,this.nextErrorWaitInterval=o,o>i)throw new Error("Proactive refresh lower bound greater than upper bound!")}start(){this.nextErrorWaitInterval=this.lowerBound,this.process(!0).catch(()=>{})}stop(){this.pending&&(this.pending.reject("cancelled"),this.pending=null)}isRunning(){return!!this.pending}async process(t){this.stop();try{this.pending=new m,this.pending.promise.catch(r=>{}),await Ce(this.getNextRun(t)),this.pending.resolve(),await this.pending.promise,this.pending=new m,this.pending.promise.catch(r=>{}),await this.operation(),this.pending.resolve(),await this.pending.promise,this.process(!0).catch(()=>{})}catch(r){this.retryPolicy(r)?this.process(!1).catch(()=>{}):this.stop()}}getNextRun(t){if(t)return this.nextErrorWaitInterval=this.lowerBound,this.getWaitDuration();{const r=this.nextErrorWaitInterval;return this.nextErrorWaitInterval*=2,this.nextErrorWaitInterval>this.upperBound&&(this.nextErrorWaitInterval=this.upperBound),r}}}function Ce(e){return new Promise(t=>{setTimeout(t,e)})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function He(e){if(U()){let t;try{t=await xe(e)}catch(r){p.warn(`Failed to read token from IndexedDB. Error: ${r}`)}return t}}function A(e,t){return U()?Me(e,t).catch(r=>{p.warn(`Failed to write token to IndexedDB. Error: ${r}`)}):Promise.resolve()}async function Be(){let e;try{e=await $e()}catch{}if(e)return e;{const t=ae();return Oe(t).catch(r=>p.warn(`Failed to persist debug token to IndexedDB. Error: ${r}`)),t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function C(){return b().enabled}async function S(){const e=b();if(e.enabled&&e.token)return e.token.promise;throw Error(`
            Can't get debug token in production mode.
        `)}function Fe(){const e=se(),t=b();if(t.initialized=!0,typeof e.FIREBASE_APPCHECK_DEBUG_TOKEN!="string"&&e.FIREBASE_APPCHECK_DEBUG_TOKEN!==!0)return;t.enabled=!0;const r=new m;t.token=r,typeof e.FIREBASE_APPCHECK_DEBUG_TOKEN=="string"?r.resolve(e.FIREBASE_APPCHECK_DEBUG_TOKEN):r.resolve(Be())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Le={error:"UNKNOWN_ERROR"};function Ue(e){return ue.encodeString(JSON.stringify(e),!1)}async function y(e,t=!1){const r=e.app;R(r);const n=l(r);let o=n.token,i;if(o&&!f(o)&&(n.token=void 0,o=void 0),!o){const a=await n.cachedTokenPromise;a&&(f(a)?o=a:await A(r,void 0))}if(!t&&o&&f(o))return{token:o.token};let s=!1;if(C()){n.exchangeTokenPromise||(n.exchangeTokenPromise=P(G(r,await S()),e.heartbeatServiceProvider).finally(()=>{n.exchangeTokenPromise=void 0}),s=!0);const a=await n.exchangeTokenPromise;return await A(r,a),n.token=a,{token:a.token}}try{n.exchangeTokenPromise||(n.exchangeTokenPromise=n.provider.getToken().finally(()=>{n.exchangeTokenPromise=void 0}),s=!0),o=await l(r).exchangeTokenPromise}catch(a){a.code==="appCheck/throttled"?p.warn(a.message):p.error(a),i=a}let c;return o?i?f(o)?c={token:o.token,internalError:i}:c=H(i):(c={token:o.token},n.token=o,await A(r,o)):c=H(i),s&&te(r,c),c}async function Ke(e){const t=e.app;R(t);const{provider:r}=l(t);if(C()){const n=await S(),{token:o}=await P(G(t,n),e.heartbeatServiceProvider);return{token:o}}else{const{token:n}=await r.getToken();return{token:n}}}function Z(e,t,r,n){const{app:o}=e,i=l(o),s={next:r,error:n,type:t};if(i.tokenObservers=[...i.tokenObservers,s],i.token&&f(i.token)){const c=i.token;Promise.resolve().then(()=>{r({token:c.token}),$(e)}).catch(()=>{})}i.cachedTokenPromise.then(()=>$(e))}function ee(e,t){const r=l(e),n=r.tokenObservers.filter(o=>o.next!==t);n.length===0&&r.tokenRefresher&&r.tokenRefresher.isRunning()&&r.tokenRefresher.stop(),r.tokenObservers=n}function $(e){const{app:t}=e,r=l(t);let n=r.tokenRefresher;n||(n=ze(e),r.tokenRefresher=n),!n.isRunning()&&r.isTokenAutoRefreshEnabled&&n.start()}function ze(e){const{app:t}=e;return new Pe(async()=>{const r=l(t);let n;if(r.token?n=await y(e,!0):n=await y(e),n.error)throw n.error;if(n.internalError)throw n.internalError},()=>!0,()=>{const r=l(t);if(r.token){let n=r.token.issuedAtTimeMillis+(r.token.expireTimeMillis-r.token.issuedAtTimeMillis)*.5+3e5;const o=r.token.expireTimeMillis-300*1e3;return n=Math.min(n,o),Math.max(0,n-Date.now())}else return 0},M.RETRIAL_MIN_WAIT,M.RETRIAL_MAX_WAIT)}function te(e,t){const r=l(e).tokenObservers;for(const n of r)try{n.type==="EXTERNAL"&&t.error!=null?n.error(t.error):n.next(t)}catch{}}function f(e){return e.expireTimeMillis-Date.now()>0}function H(e){return{token:Ue(Le),error:e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class re{constructor(t){this._siteKey=t,this._throttleData=null}async getToken(){var t,r,n;tt(this._throttleData);const o=await Je(this._app).catch(s=>{throw u.create("recaptcha-error")});if(!(!((t=l(this._app).reCAPTCHAState)===null||t===void 0)&&t.succeeded))throw u.create("recaptcha-error");let i;try{i=await P(Ie(this._app,o),this._heartbeatServiceProvider)}catch(s){throw!((r=s.code)===null||r===void 0)&&r.includes("fetch-status-error")?(this._throttleData=et(Number((n=s.customData)===null||n===void 0?void 0:n.httpStatus),this._throttleData),u.create("throttled",{time:j(this._throttleData.allowRequestsAfter-Date.now()),httpStatus:this._throttleData.httpStatus})):s}return this._throttleData=null,i}initialize(t){this._app=t,this._heartbeatServiceProvider=L(t,"heartbeat"),Xe(t,this._siteKey).catch(()=>{})}isEqual(t){return t instanceof re?this._siteKey===t._siteKey:!1}}function et(e,t){if(e===404||e===403)return{backoffCount:1,allowRequestsAfter:Date.now()+Re,httpStatus:e};{const r=t?t.backoffCount:0,n=le(r,1e3,2);return{backoffCount:r+1,allowRequestsAfter:Date.now()+n,httpStatus:e}}}function tt(e){if(e&&Date.now()-e.allowRequestsAfter<=0)throw u.create("throttled",{time:j(e.allowRequestsAfter-Date.now()),httpStatus:e.httpStatus})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function st(e=ne(),t){e=oe(e);const r=L(e,"app-check");if(b().initialized||Fe(),C()&&S().then(o=>console.log(`App Check debug token: ${o}. You will need to add it to your app's App Check settings in the Firebase console for it to work.`)),r.isInitialized()){const o=r.getImmediate(),i=r.getOptions();if(i.isTokenAutoRefreshEnabled===t.isTokenAutoRefreshEnabled&&i.provider.isEqual(t.provider))return o;throw u.create("already-initialized",{appName:e.name})}const n=r.initialize({options:t});return rt(e,t.provider,t.isTokenAutoRefreshEnabled),l(e).isTokenAutoRefreshEnabled&&Z(n,"INTERNAL",()=>{}),n}function rt(e,t,r){const n=Ae(e,Object.assign({},W));n.activated=!0,n.provider=t,n.cachedTokenPromise=He(e).then(o=>(o&&f(o)&&(n.token=o,te(e,{token:o.token})),o)),n.isTokenAutoRefreshEnabled=r===void 0?e.automaticDataCollectionEnabled:r,n.provider.initialize(e)}const nt="app-check",F="app-check-internal";function ot(){D(new N(nt,e=>{const t=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat");return qe(t,r)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider(F).initialize()})),D(new N(F,e=>{const t=e.getProvider("app-check").getImmediate();return je(t)},"PUBLIC").setInstantiationMode("EXPLICIT")),de(Ge,Ve)}ot();export{re as ReCaptchaV3Provider,st as initializeAppCheck};
