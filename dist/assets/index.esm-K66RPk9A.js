import{U as y,V as I,W as N,I as C,_ as D,J as g,Y as O,Z as _}from"./firebase-DZ7g1HBb.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const H="auth-internal",J="app-check-internal",V="messaging-internal";function Y(e,t){const n=(r,{instanceIdentifier:i})=>{const o=r.getProvider("app").getImmediate(),s=r.getProvider(H),c=r.getProvider(V),l=r.getProvider(J);return new R(o,s,c,l,i,e)};y(new I(m,n,"PUBLIC").setMultipleInstances(!0)),N(A,k,t),N(A,k,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function K(e=C(),t=p){const r=D(g(e),m).getImmediate({identifier:t}),i=O("functions");return i&&B(r,...i),r}function B(e,t,n){F(g(e),t,n)}function q(e,t,n){return x(g(e),t,n)}Y(fetch.bind(self));export{B as connectFunctionsEmulator,K as getFunctions,q as httpsCallable};
