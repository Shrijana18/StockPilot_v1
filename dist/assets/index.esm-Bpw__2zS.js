import{I as ne,J as oe,_ as F,K as ie,L as se,M as m,N as ae,P as ce,Q as U,R as le,S as ue,U as D,V as N,W as de}from"./firebase-DZ7g1HBb.js";/**
 * @license
 ...
 */function C(){return b().enabled}async function S(){const e=b();if(e.enabled&&e.token)return e.token.promise;throw Error(`
        ...
        `)}function Le(){const e=se(),t=b();if(t.initialized=!0,typeof e.FIREBASE_APPCHECK_DEBUG_TOKEN!="string"&&e.FIREBASE_APPCHECK_DEBUG_TOKEN!==!0)return;t.enabled=!0;const r=new m;t.token=r,typeof e.FIREBASE_APPCHECK_DEBUG_TOKEN=="string"?r.resolve(e.FIREBASE_APPCHECK_DEBUG_TOKEN):r.resolve(He())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
